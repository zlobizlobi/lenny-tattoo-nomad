...
import { SubmitButton, SectionContainer, Heading, ColumnContainer } from "../../components";
import {
  Container,
  Text,
  TextArea,
  ...
  <SectionContainer>
    <Scroll.Element name="contact-section">
      <ColumnContainer>
        ...
        <Container>
          <Text>
            Want to know more or book an appointment? Don't be shy to call or send me a message.
          </Text>
